import { createTagAction } from "@/features/taxonomy/server/taxonomy.actions";
import { listTags } from "@/features/taxonomy/server/taxonomy.queries";
import { handleApi, jsonData, jsonError, readJson } from "@/lib/api/http";

export async function GET() {
  return handleApi(async () => jsonData(await listTags()));
}
